...
public class videoList {
    ...
    public Video search (String v) {
        if (!isEmpty()) {
            Video current = first;
            while (current != null) {
                if ((current.getMovieName()).equalsIgnoreCase(v))
                    return current;
                current = current.nextVideo;
            }
        }
     ...
     */
    public boolean insertFirst (Video v) {
     ...
     * @return true if inserted
     */
    public boolean insertLast (Video v) {
        if (search(v.getReference()) != null)
            return false;
        if (isEmpty()) {
            first = v;
     ...
     */
    public boolean deleteVideo (int filmReference) {
        boolean found = false;
     ...
     * @return 
     */
    public boolean videoCheckIn (Video v) {
        Video temp = search(v.getReference());
        if (temp != null) {
            System.out.println ("We have rented this video to you");            
            if (temp.returnVideo()) {
        ...
        System.out.println ("We have not rented this video to you");   
        return false;
    }
     ...
     */
    public boolean videoCheckOut (Video v) {
        Video temp = search(v.getReference());
        if (temp == null) {
            System.out.println ("You don't currently have this video rented out");      
            if (v.rentVideo()) {
        ...
        System.out.println ("You currently have this video rented out");      
        return false;
    }
     ...
     * change
     */
    public boolean addStock (int reference, int add) {
     ...
     * change
     */
    public boolean addStock (String name, int add) {
        Video v = search(name);
        if (v != null) {
            v.addStock(add);
            return true;
     ...
     * change
     */
    public boolean setStock (int reference, int set) {
        Video v = search(reference);
        if (v != null) {
            v.setStock(set);
            return true;
     ...
     * change
     */
    public boolean setStock (String reference, int set) {
        Video v = search(reference);
        if (v != null) {
            v.setStock(set);
            return true;

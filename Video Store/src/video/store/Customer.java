...
public class Customer {
     ...
     */
    public void print () {
        System.out.println (FirstName + " " + LastName + "\t" + membershipNumber);
    }
     ...
     */
    public boolean rentVideo (String reference) {
        Video v = Global.inventory.search(reference);
        if (v != null) {
            System.out.println ("We have this video in our inventory");
            if (rentedVideos.videoCheckOut(v)) {
                System.out.println ("We hope you enjoy " + v.getMovieName());
                return true;
            }        
            else
                return false;
        }
        System.out.println ("We don't have this video in our inventory");
        return false;
    }
     ...
     * inventory is reflective of it
     */
    public boolean rentVideo (int reference) {
        Video v = Global.inventory.search(reference);
        if (v != null) {
            System.out.println ("We have this video in our inventory");
            if (rentedVideos.videoCheckOut(v)) {
     ...
     * inventory is reflective of it
     */
    public boolean returnVideo (String reference) {
        Video v = Global.inventory.search(reference);
        if (v != null) {
            System.out.println ("We have this video in our inventory");
            if (rentedVideos.videoCheckIn(v)) {
                System.out.println ("Thank you for returning " + v.getMovieName());
                return true;
            }
            else
                return false;
     ...
     * inventory is reflective of it
     */
    public boolean returnVideo (int reference) {
        Video v = Global.inventory.search(reference);
        if (v != null) {
            System.out.println ("We have this video in our inventory");
            if (rentedVideos.videoCheckIn(v)) {

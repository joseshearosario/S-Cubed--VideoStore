...
public class Video {
    ...
    public void printVideo () {
        System.out.println (getMovieName() + "\t" + getReleaseYear() + "\t" + getReference() + "\t" + getStock() + "\t" + getCirculation());
    }
     ...
     */
    public boolean rentVideo() {
        if (isAvailable()) {
            inStock = inStock - 1;
            inCirculation = inCirculation + 1;
            System.out.println ("Our records now reflect your rental");
            return true;
        }
        System.out.println ("There are no available copies of this video");
        return false;
    }
    ...
    public boolean returnVideo() {
        if (inCirculation < 1) {
            System.out.println ("Our records indicate that we have none of these vides in circulation");
            return false;
        }
        inCirculation = inCirculation - 1;
        inStock = inStock + 1;
        System.out.println ("Our records now reflect your return");
        return true;
    }
     ...
     */
    public boolean removeStock (int i) {
        if (i <= getStock()) {
            inStock = inStock - i;
            return true;
        }
